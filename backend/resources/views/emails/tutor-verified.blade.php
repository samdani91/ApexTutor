  ...
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:20px;">
    <tr>
      <td style="background:#F0FDF4;border:1px solid #BBF7D0;border-radius:12px;padding:18px 20px;text-align:center;">
        <p style="margin:0 0 5px;font-size:12px;color:#166534;font-weight:700;text-transform:uppercase;letter-spacing:0.4px;">Status</p>
        <p style="margin:0;font-size:18px;font-weight:800;color:#14532D;">Verified Tutor</p>
      </td>
    </tr>
  </table>

  <p style="margin:0 0 18px;font-size:14px;color:#4A4332;line-height:1.7;">
    Keep your profile up to date to attract more guardians. A complete profile with a photo, detailed bio and clear preferences gets significantly more views.
  </p>
