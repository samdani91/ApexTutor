@extends('emails.layout', [
  ...
  'preheader' => 'Your TutorKhujo tutor profile has been updated by an admin.',
])
...
@section('content')
  ...
  <p style="margin:0 0 16px;font-size:14px;color:#4A4332;line-height:1.7;">
    An admin on TutorKhujo has made updates to your tutor profile. These changes are now live on your profile.
  </p>
  ...
  <p style="margin:0;padding-top:18px;border-top:1px solid #ECE6D5;font-size:13px;color:#6B6248;line-height:1.6;">
    You can view your profile details by logging into your TutorKhujo dashboard.
  </p>
@endsection
