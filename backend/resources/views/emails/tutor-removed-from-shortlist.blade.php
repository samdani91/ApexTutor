...
@section('content')
  ...
  <p style="margin:0 0 20px;font-size:14px;color:#4A4332;line-height:1.7;">
    We wanted to let you know that <strong style="color:#0F2E5C;">{{ $guardianName }}</strong> has removed you from their shortlist on Apex Tutor.
  </p>
  ...
  <p style="margin:0;padding-top:18px;border-top:1px solid #ECE6D5;font-size:13px;color:#6B6248;line-height:1.6;">
    Log in to your Apex Tutor dashboard to review your profile and keep it as strong as possible.
  </p>
@endsection
