@extends('emails.layout', [
  'accentColor' => '#059669',
  'icon' => '&#10003;',
  'headline' => 'Tuition Confirmed',
  'subheadline' => 'A new tuition has been arranged for you',
  'preheader' => "Your tuition with {$guardianName} has been confirmed.",
])
...
@section('content')
  ...
  <p style="margin:0 0 20px;font-size:14px;color:#4A4332;line-height:1.7;">
    Congratulations. Your tuition with <strong style="color:#0F2E5C;">{{ $guardianName }}</strong>
    has been officially confirmed by our admin team.
  </p>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom:20px;">
    <tr>
      <td style="background:#F0FDF4;border:1px solid #BBF7D0;border-radius:12px;padding:18px 20px;text-align:center;">
        <p style="margin:0 0 5px;font-size:12px;color:#166534;font-weight:700;text-transform:uppercase;letter-spacing:0.4px;">Confirmed Tuition With</p>
  ...
  <p style="margin:0 0 18px;font-size:14px;color:#4A4332;line-height:1.7;">
    Our team will provide the guardian's contact details so you can coordinate the schedule, location and specific tuition requirements.
  </p>
