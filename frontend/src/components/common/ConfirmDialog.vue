        ...
        <div class="bg-white rounded-sm shadow-xl w-full max-w-sm p-6">
          ...
          <div class="flex gap-3 mt-2">
            <button @click="$emit('cancel')"
              class="flex-1 text-sm font-semibold font-display py-2 rounded-md border border-paper-300 bg-paper-100 text-paper-700 hover:bg-paper-200 transition-colors">
              Cancel
            </button>
            <button @click="$emit('confirm')"
              class="flex-1 text-sm font-semibold font-display py-2 rounded-md transition-colors"
              :class="danger ? 'bg-red-600 text-white hover:bg-red-700' : 'bg-navy-700 text-white hover:bg-navy-800'">
